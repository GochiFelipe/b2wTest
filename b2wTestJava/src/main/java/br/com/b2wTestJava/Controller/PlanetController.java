...
public class PlanetController {
	...
	public void savePlanet(@RequestBody PlanetJson planetJson) {
		Planet planet;
		if (planetJson.getId() == null) 
			planet = new Planet(planetJson.getName(), planetJson.getClimate(), planetJson.getTerrain(), null);
		else
			planet = new Planet(planetJson.getId(), planetJson.getName(), planetJson.getClimate(), planetJson.getTerrain(), null);
